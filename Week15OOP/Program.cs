...
{
    Console.WriteLine($"One of my favourite movies {movie.title} was released in {movie.year} with rating of {movie.rating}.");
}

static string[] GetDataFromFile()
{
    string filePath = @"C:\Users\germo\Documents\TKTK\c#\movies.txt";
